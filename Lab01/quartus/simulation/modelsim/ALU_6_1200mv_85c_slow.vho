...
-- Equation(s):
-- \multiplexer_0|Mux31~7_combout\ = (\op[4]~input_o\ & (\multiplexer_0|Mux31~3_combout\ $ (((!\add_sub_0|temp[31]~62_combout\))))) # (!\op[4]~input_o\ & (((\multiplexer_0|Mux31~6_combout\))))
...
PORT MAP (
	...
	datac => \add_sub_0|temp[31]~62_combout\,
	datad => \op[4]~input_o\,
